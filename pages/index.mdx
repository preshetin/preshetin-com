...
Hey, I'm a freelance engineer from Minsk, Belarus. I enjoy working with TypeScript, React.js, Slack API, SST, Arduino and crafting apps for tools like Slack, Airtable and Miro.
...
- Instagram [@preshetin](https://instagram.com/preshetin)
